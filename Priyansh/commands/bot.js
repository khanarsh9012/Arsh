...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "julmi") || (event.body.toLowerCase() == "jamal pathan") || (event.body.toLowerCase() == "जमाल") || (event.body.toLowerCase() == "जमाल पठान")) {
     return api.sendMessage( " Mera Jamal Babu Busy Hoga Work Me Yha Ma To Hun Na https://www.facebook.com/share/1B84wpQ7gg/"
   ...
   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("JAMAL PATHAN  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Jamal Pathan. He Gives his name Jamal everywharehttps://www.facebook.com/share/1NkEZ5RHg5/", threadID);
   };
