...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "jamal") || (event.body.toLowerCase() == "julmi jaat") || (event.body.toLowerCase() == "जमाल") || (event.body.toLowerCase() == "जमाल पठान")) {
     return api.sendMessage( " Jamal Busy HoGa Work Me Yha Main t0o Hun Na https://www.facebook.com/share/1GNaEnAhbv/=ZbWKwL😘",threadID);


   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:-☞𝗝𝗔𝗠𝗔𝗟 𝗣𝗔𝗧𝗛𝗔𝗡☜💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝗝𝗔𝗠𝗟𝗨\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/share/1GNaEnAhbv/\n👋For Any Kind Of Help Contact On Instagram Username 👉https://www.instagram.com/alex972740?igsh=MWNpbDFnMzYyM3p5Nw==😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("𝗝𝗔𝗠𝗔𝗟 𝗣𝗔𝗧𝗛𝗔𝗡 ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Jamal Pathan. He Gives his name Jamal everywharehttps://www.facebook.com/share/1GNaEnAhbv/=ZbWKwL", threadID);
   };
...
if ((event.body.toLowerCase() == "I love you") || (event.body.toLowerCase() == "Love you ")) {
  ...
  if ((event.body.toLowerCase() == "ami jamal") || (event.body.toLowerCase() == "ami jamal patham") || (event.body.toLowerCase() == "main julmi jaat") || (event.body.toLowerCase() == "main julmi") || (event.body.toLowerCase() == "main jaat")) {
